...
func GetAPIProviderHandler(ctx context.Context, c *app.RequestContext) {
	...
	// 获取Provider
	provider, err := services.GetAPIProvider(userPhone.(string), uint(providerID))
	if err != nil {
...
func ListAPIProvidersHandler(ctx context.Context, c *app.RequestContext) {
	...
	// 获取Provider列表
	providers, err := services.ListAPIProviders(userPhone.(string), apiType, status)
	if err != nil {
...
func UpdateAPIProviderHandler(ctx context.Context, c *app.RequestContext) {
	...
	// 更新Provider
	if err := services.UpdateAPIProvider(userPhone.(string), uint(providerID), &req); err != nil {
...
func DeleteAPIProviderHandler(ctx context.Context, c *app.RequestContext) {
	...
	// 删除Provider
	if err := services.DeleteAPIProvider(userPhone.(string), uint(providerID)); err != nil {
